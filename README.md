...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yakki-a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yakki-a.containers.anotherwebservice.com/
...
```
git clone git@github.com:fazin-ahamed/container-yakki-a.git
cd container-yakki-a
```
...
```
docker attach container-yakki-a
```
